...
MStatus circle::initialize()
{
        ...
        addAttribute( scale );
        addAttribute( frames );
        addAttribute( sOutput );
        addAttribute( cOutput );

        // Set the attribute dependencies
        //
        attributeAffects( input, sOutput );
        attributeAffects( input, cOutput );
        attributeAffects( scale, sOutput );
        attributeAffects( scale, cOutput );
        attributeAffects( frames, sOutput );
        attributeAffects( frames, cOutput );
